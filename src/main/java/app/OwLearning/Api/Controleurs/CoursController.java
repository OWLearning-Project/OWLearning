...
public class CoursController {
    ...
    public ResponseEntity<List<CoursResponse>> getCoursCrees(@AuthenticationPrincipal UtilisateurAuthentifieRequest utilisateurAuthentifieDTO)
    {
    ...
    public ResponseEntity<List<CoursResponse>> getCoursInscriptions(@AuthenticationPrincipal UtilisateurAuthentifieRequest utilisateurAuthentifieDTO)
    {
    ...
    @PreAuthorize("hasAuthority('CREATEUR')")
    @PostMapping
    public ResponseEntity<CoursResponse> creerCours(@RequestBody CoursCreationRequest coursCreationDTO, @AuthenticationPrincipal UtilisateurAuthentifieRequest utilisateurAuthentifieDTO)
    {
