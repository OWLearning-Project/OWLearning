...
Cette commande télécharge l'image PostgreSQL 16, monte le volume de données et exécute le script `init.sql`.
...
| `POST` | `/connexion` | Public | Authentifie l'utilisateur et retourne le token JWT. |
